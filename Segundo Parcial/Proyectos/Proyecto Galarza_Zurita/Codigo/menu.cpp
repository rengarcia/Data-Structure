...
void cuatro(WORD Attributes){
	cout << endl;
	cout<<"\tJugar \t CodigoQR \t Codigo de Barras \t ";
	SetConsoleColour(&Attributes, FOREGROUND_BLUE | BACKGROUND_INTENSITY | BACKGROUND_GREEN);
...
void cinco(WORD Attributes){
	cout << endl;
	cout<<"\tJugar \t CodigoQR \t Codigo de Barras \t Sello Pixeleado \t";
	SetConsoleColour(&Attributes, FOREGROUND_BLUE | BACKGROUND_INTENSITY | BACKGROUND_GREEN);
	cout<<"Salir";
	ResetConsoleColour(Attributes);
}
...
int main()
{
	...
	int met,tecla,opc=0;
		...
		cout << endl;
		cout<<"\tJugar \t CodigoQR \t Codigo de Barras \t Sello Pixeleado \t Salir "<<endl;
	do{
